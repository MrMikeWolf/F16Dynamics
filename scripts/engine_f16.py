...
def thrust(power, alt_ft, rmach): 
    ...
    T = B[M+1][I]*CDH + B[M+1][I]*DH
    TMIL = S + (T-S)*DM
    if (power < 50.0):
        S = A[M+1][I]  *CDH + A[M+1][I]  *DH
        T = A[M+1][I]*CDH + A[M+1][I]*DH
        TIDL = S + (T-S)*DM
        y = TIDL + (TMIL-TIDL)*power*.02
    else:
        S = C[M+1][I]  *CDH + C[M+1][I]  *DH
        T = C[M+1][I]*CDH + C[M+1][I]*DH
        TMAX = S + (T-S)*DM
        y = TMIL + (TMAX-TMIL)*(power-50.0)*.02
